                    ...
                    <div className="main-content main-content-table overflow-auto">
                        <table className="table table-borderless">
                            ...
                            <tbody id="list_status_item">
                                <TableRow image="overview-1" title="Mobile Legends: The New Battle 2021" categorie="Desktop" item={200} price={120000} status="Pending" />
                                <TableRow image="overview-2" title="Call of Duty:Modern" categorie="Desktop" item={550} price={740000} status="Success" />
                                <TableRow image="overview-3" title="Clash of Clans" categorie="Mobile" item={100} price={120000} status="Failed" />
                                <TableRow image="overview-4" title="The Royal Game" categorie="Mobile" item={225} price={200000} status="Pending" />
                            </tbody>
                        </table>
                    </div>
                </div>
